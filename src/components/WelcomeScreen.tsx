...
export const WelcomeScreen: React.FC = () => {
  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-between bg-[#EBF3ED] dark:bg-slate-950 font-sans select-none transition-colors duration-200 relative">
      
      {/* =================================================================== */}
      {/* TOP BRANDING SECTION                                                */}
      {/* =================================================================== */}
      <header className="w-full pt-[max(0.6rem,env(safe-area-inset-top,0px))] px-4 sm:px-6 lg:px-8 relative z-20 flex-shrink-0">
        <div className="w-full flex items-center justify-between relative max-w-6xl mx-auto">
          <div className="w-20 sm:w-24" /> {/* Spacer to balance top-right language selector */}
          
          {/* Centered Feeder Logo */}
          ...
          {/* Language Selector (Top-Right matching reference exactly) */}
          <div className="w-20 sm:w-24 flex justify-end relative">
            <button
              type="button"
              onClick={() => setShowLangMenu(!showLangMenu)}
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-white/90 dark:bg-slate-800/90 backdrop-blur-xs border border-slate-200/80 dark:border-slate-700/80 text-[11px] font-semibold text-slate-700 dark:text-slate-200 shadow-2xs hover:bg-white dark:hover:bg-slate-800 transition-colors cursor-pointer"
        ...
        <div className={`text-center px-4 mt-1 sm:mt-1.5 mb-1 ${animateEntrance ? 'anim-feeder-tagline' : ''}`}>
          <h1 className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl font-extrabold text-[#1E4D2B] dark:text-green-300 tracking-tight leading-tight font-['Outfit',sans-serif]">
            A kinder world for every animal.
          </h1>
          <p className="text-[10px] xs:text-[11px] sm:text-xs md:text-sm font-semibold text-[#1E4D2B]/85 dark:text-green-300/85 tracking-wide mt-0.5">
      ...
      {/* =================================================================== */}
      {/* HERO ANIMAL ARTWORK AREA (Clean animals on rocks against mountains)  */}
      {/* =================================================================== */}
      <div className={`w-full flex-1 flex items-end justify-center relative overflow-hidden select-none min-h-[140px] xs:min-h-[160px] sm:min-h-[200px] md:min-h-[240px] lg:min-h-[270px] max-h-[30vh] sm:max-h-[34vh] md:max-h-[38vh] ${animateEntrance ? 'anim-feeder-hero' : ''}`}>
        <div className="w-full max-w-4xl h-full flex items-end justify-center px-2 sm:px-4">
          <img
            src="/assets/feeder-animals-hero.png"
            alt="Feeder Animal Friends"
            className="w-full h-full max-h-full object-contain sm:object-cover object-bottom select-none pointer-events-none"
      ...
      {/* =================================================================== */}
      {/* BOTTOM AUTHENTICATION PANEL (Spans full viewport width with rounded top) */}
      {/* =================================================================== */}
      <main className={`w-full bg-white dark:bg-slate-900 rounded-t-[32px] sm:rounded-t-[40px] md:rounded-t-[44px] shadow-[0_-12px_40px_rgba(0,0,0,0.06)] dark:shadow-[0_-12px_40px_rgba(0,0,0,0.4)] -mt-3 sm:-mt-5 relative z-10 px-4 xs:px-5 sm:px-8 md:px-12 pt-3 sm:pt-4 pb-[max(0.75rem,env(safe-area-inset-bottom,0px))] flex flex-col justify-between flex-shrink-0 ${animateEntrance ? 'anim-feeder-panel' : ''}`}>
        
        {/* Feature Icon Row (6 features matching reference in exact order) */}
        <div className="w-full max-w-xl mx-auto mb-2 sm:mb-2.5">
          <div className="grid grid-cols-6 gap-1 sm:gap-2 text-center pb-2 border-b border-slate-100 dark:border-slate-800 select-none">
            {/* 1. Find Help */}
            <div className="flex flex-col items-center">
              <div className="w-8 h-8 xs:w-9 xs:h-9 sm:w-10 sm:h-10 rounded-full bg-[#EAF2EC] dark:bg-green-950/60 flex items-center justify-center text-[#1E4D2B] dark:text-green-400 mb-0.5 shadow-2xs">
                <PawPrint className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </div>
              <span className="text-[7.5px] xs:text-[8px] sm:text-[9px] font-medium text-slate-700 dark:text-slate-300 leading-tight">Find Help</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[7.5px] xs:text-[8px] sm:text-[9px] font-medium text-slate-700 dark:text-slate-300 leading-tight">Adopt</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[7.5px] xs:text-[8px] sm:text-[9px] font-medium text-slate-700 dark:text-slate-300 leading-tight">Support Feeding</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[7.5px] xs:text-[8px] sm:text-[9px] font-medium text-slate-700 dark:text-slate-300 leading-tight">Know Your Rights</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[7.5px] xs:text-[8px] sm:text-[9px] font-medium text-slate-700 dark:text-slate-300 leading-tight">Learn & Explore</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[7.5px] xs:text-[8px] sm:text-[9px] font-medium text-slate-700 dark:text-slate-300 leading-tight">Join a Community</span>
            </div>
          </div>
        </div>
